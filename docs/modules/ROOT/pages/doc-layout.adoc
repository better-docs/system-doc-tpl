...
The system documentation is split into sections that _describe the system_  like xref:arc42:01_introduction_and_goals.adoc[architecture], operating manual and business processes and sections that _describe things that change_ like planning, ideas, ... (see <<fig-system-documentation>>).
